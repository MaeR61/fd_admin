                ...
                children: [
                  ...
                  GestureDetector(
                    ...
                    onTap: () {
                      ...
                      context.read<HomeIndexCubit>().setCurrentIndex(10);
                    },
                  ...
                  GestureDetector(
                    behavior: HitTestBehavior.translucent,
                    onTap: () {
                      context.read<DrugInfoViewModel>().fetchUDrugs();
                      context.read<HomeIndexCubit>().setCurrentIndex(10);
                    },
                    child: MaeRHorizontalCard(
                      width: context.dynamicWidth(0.9),
                ...
                child: Row(
                  ...
                  children: [
                    SizedBox(
                      ...
                      child: Image.asset(
                        SectionedCardEnums.values[index + 6].image,
                        fit: BoxFit.contain,
                      ),
                    ),
                    SizedBox(
                      ...
                      child: Column(
                        children: [
                          Text(
                            SectionedCardEnums.values[index + 6].title,
                          ...
                          Text(
                            SectionedCardEnums.values[index + 6].info,
