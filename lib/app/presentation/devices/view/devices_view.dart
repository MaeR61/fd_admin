                ...
                children: [
                  ...
                  GestureDetector(
                    ...
                    onTap: () {
                      ...
                      context.read<HomeIndexCubit>().setCurrentIndex(11);
                    },
                ...
                child: Row(
                  ...
                  children: [
                    SizedBox(
                      ...
                      child: Image.asset(
                        SectionedCardEnums.values[index + 9].image,
                        fit: BoxFit.contain,
                      ),
                    ),
                    SizedBox(
                      ...
                      child: Column(
                        children: [
                          Text(
                            SectionedCardEnums.values[index + 9].title,
                          ...
                          Text(
                            SectionedCardEnums.values[index + 9].info,
