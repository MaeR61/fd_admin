...
class TobaccoView extends StatelessWidget {
  const TobaccoView({super.key});
                ...
                children: [
                  ...
                  GestureDetector(
                    ...
                    onTap: () {
                      ...
                      context.read<HomeIndexCubit>().setCurrentIndex(13);
                    },
                ...
                child: Row(
                  ...
                  children: [
                    SizedBox(
                      ...
                      child: Image.asset(
                        SectionedCardEnums.values[index + 15].image,
                        fit: BoxFit.contain,
                      ),
                    ),
                    SizedBox(
                      ...
                      child: Column(
                        children: [
                          Text(
                            SectionedCardEnums.values[index + 15].title,
                          ...
                          Text(
                            SectionedCardEnums.values[index + 15].info,
